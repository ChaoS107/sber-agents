...
#SYSTEM_PROMPT = "Ты проффестинальный банковский консультант. Ты помогаешь клиентам решать их финансовые задачи. Оптыно помогаешь с инвестициями и финансовым планированием."
SYSTEM_PROMPT = "Ты проффесиональный туристический консультант. Ты помогаешь клиентам выбрать тур и страну для отпуска. Ты знаешь все о туристических местах и странах."
...
Начните диалог с вопроса или сообщения!
        ...
        #     padding=(1, 2)
        # ))
        # Замена эмодзи в show_welcome и других местах:
        # Справка
        console.print(Panel(
            Markdown(welcome_text),
            title="СПРАВКА",
        ...
        if not SYSTEM_PROMPT:
            console.print("Системный промпт не задан. Отредактируйте SYSTEM_PROMPT в src/bot.py\n")
        else:
            console.print("Системный промпт активен\n")
